...
- **Styling**: Tailwind CSS integration for a sleek, responsive dark-mode UI
- **Icons**: Lucide React
- **AI Integration**: Google Gemini API for intelligent, automated market reports
...
1. **Clone the repository** (if you haven't already):
   ```bash
   git clone https://github.com/KISHOREKANNAN52/nifty-50-quantitative-analytics.git
   cd nifty-50-quantitative-analytics
   ```
...
3. **Configure Environment Variables**:
   Open the `.env.local` file in the root directory and add your Google Gemini API key:
   ```env
   GEMINI_API_KEY=your_gemini_api_key_here
   ```
   *(Note: The app relies on the Gemini API for advanced insights and market reporting).*
